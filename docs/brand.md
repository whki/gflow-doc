...
| 层级 | 口号 | 用途 |
|---|---|---|
| 品牌主口号 | **AI 先审 · 人再签 · 签完自动办** | 品牌物料、首页 hero、发布会主视觉 |
| 功能叙事口号 | 批完，自动办。 | 产品大标题、副标、价格页、演示讲解词 |

使用规范：

- 品牌主口号与产品名**成对出现**：「GFlow 极风工作流平台——AI 先审 · 人再签 · 签完自动办」——口号不替换产品名
- 主口号的三段顺序不可调换（AI → 人 → 自动办），顺序本身就是产品哲学
